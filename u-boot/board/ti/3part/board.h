...
{
	return 0;//return board_ti_is("A335BONE");
}

static inline int board_is_bone_lt(void)
{
	return 0;//return board_ti_is("A335BNLT");
}

static inline int board_is_pb(void)
{
	return 0;//return board_ti_is("A335PBGL");
}
...
{
	return 0;//return board_ti_is("A335X_SK");
}

static inline int board_is_idk(void)
{
	return 0;//return !strncmp(board_ti_get_config(), "SKU#02", 6);
}

static inline int board_is_gp_evm(void)
{
	return 0;//return board_ti_is("A33515BB");
}
...
{
	return 0;//return board_ti_is("A335_ICE") && !strncmp("2", board_ti_get_rev(), 1);
}
