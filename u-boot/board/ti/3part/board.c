...
/******************* AM335x-3part based changed *******************/

static const struct ddr_data ddr3_AM3352_3part_ddr_data	= {
	.datardsratio0 =	0x00000040	,
	.datawdsratio0 =	0x00000081	,
	.datafwsratio0 =	0x00000103	,
	.datawrsratio0 = 	0x000000C1	,
};

static const struct cmd_control ddr3_AM3352_3part_cmd_ctrl_data	= {
...
static struct emif_regs ddr3_AM3352_3part_emif_reg_data	= {
...
const struct ctrl_ioregs ddr3_AM3352_3part_ioregs_data	= {
	.cm0ioctl =	0x0000018B	,
	.cm1ioctl =	0x0000018B	,
	.cm2ioctl =	0x0000018B	,
	.dt0ioctl =	0x0000018B	,
...
/******************* AM335x-3part based changed *******************/
	config_ddr(	400, &ddr3_AM3352_3part_ioregs_data,
		&ddr3_AM3352_3part_ddr_data,
		&ddr3_AM3352_3part_cmd_ctrl_data,
		&ddr3_AM3352_3part_emif_reg_data, 0);
/******************************************************************/
#if 0
	if (board_is_evm_sk()) {
		/*
...
struct cpsw_platform_data am335_eth_data = {
	...
	.ale_entries		= 1024,
	//.bd_ram_ofs		= 0x2000,(since repetition)
	.mac_control		= 0x20,
	.active_slave		= 0,
	.mdio_base		= 0x4a101000,
	.gmii_sel		= 0x44e10650,		/*cpsw-phy-sel*/
...
{
	if (board_is_gp_evm() && !strcmp(name, "am335x-3part"))
		return 0;
