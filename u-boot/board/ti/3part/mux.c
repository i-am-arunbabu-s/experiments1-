...
static struct module_pin_mux mmc0_pin_mux[] = {
	...
	{OFFSET(mcasp0_aclkx), (MODE(4) | RXACTIVE)},		/* MMC0_WP */
...
static struct module_pin_mux mmc1_pin_mux[] = {
	...
	{OFFSET(gpmc_be0n_cle), (MODE(7) | RXACTIVE | PULLUDDIS)},	/* MMC1_CD */
	{-1},
};
...
static struct module_pin_mux mmc2_pin_mux[] = {
	...
	{OFFSET(mcasp0_axr0), (MODE(3) | RXACTIVE | PULLUP_EN)},/* MMC2_SD_CD */
	{-1},
};
/*****************************************************************/
...
static struct module_pin_mux ethernet_pin_mux[] = {
	{OFFSET(mii1_rxerr), MODE(0) | RXACTIVE},	/* MII1_RXERR */
	{OFFSET(mii1_txen), MODE(0)},			/* MII1_TXEN */
	{OFFSET(mii1_crs), MODE(0)},			/* MII1_CRS */
	{OFFSET(mii1_col), MODE(0)},			/* MII1_COL */
	{OFFSET(mii1_rxdv), MODE(0) | RXACTIVE},	/* MII1_RXDV */
	{OFFSET(mii1_txd3), MODE(0)},			/* MII1_TXD3 */
	{OFFSET(mii1_txd2), MODE(0)},			/* MII1_TXD2 */
	{OFFSET(mii1_txd1), MODE(0)},			/* MII1_TXD1 */
